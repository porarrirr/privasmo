...
public struct LocalizedStrings {
    ...
    public static let tabSensorDetails = "選択焦点距離でのセンサー詳細"
    public static let messageGenerateGraphFirst = "比較グラフを表示するには、デバイス入力で「グラフ生成 / 更新」を実行してください。"
    public static let messageGenerateSensorDetailsFirst = "センサー詳細を表示するには、先にグラフを生成してください。"
    public static let sectionComparisonGraph = "2. 比較グラフ"
    public static let sectionInteractive = "3. インタラクティブ操作"
    public static let sectionSensorDetails = "4. 選択焦点距離でのセンサー詳細"
